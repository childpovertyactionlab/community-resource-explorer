const en_US = {
  ...
  UI_MAP_METRIC_TITLE_CRI_INDEX: `Community Resource Index`,
  ...
  UI_MAP_METRIC_TITLE_HEL: `Health`,
  UI_MAP_METRIC_DESC_HEL: `<p><span>Do residents have access to health insurance, medical services, and fresh fruits and vegetables? Are residents healthy?</span><br /><br />Communities with the highest scores on this index have more access to health clinics and pharmacies and have a greater share of residents with health insurance. Communities with high Health scores also have longer life expectancies and fewer health issues.</p>`,
  ...
  UI_MAP_METRIC_TITLE_COM: `Community`,
  UI_MAP_METRIC_DESC_COM: `<p><span>Does the community have public amenities? Is the community safe? Are families and businesses secure?</span><br /><br />Communities with the highest scores on this index have more public spaces for community members, fewer cost-burdened households, and fewer residential and business vacancies.</p>`,
  UI_MAP_METRIC_TITLE_YTH: `Youth & Family`,
  UI_MAP_METRIC_DESC_YTH: `<p><span>Are families able to access childcare and youth programs in the community?</span><br /><br />Communities with the highest scores on this index are more likely to have greater access to afterschool programs, quality early childhood education, and more two-parent households among families with children.</p>`,
  UI_MAP_METRIC_TITLE_ECO_INDEX: `Economic Opportunity Index`,
  UI_MAP_METRIC_DESC_ECO_INDEX: `This index measures economic opportunity in the community, including access to jobs, income, and financial services.`,
  ...
  UI_MAP_METRIC_TITLE_HEL_INDEX: `Health Index`,
  UI_MAP_METRIC_DESC_HEL_INDEX: `This index measures health access and outcomes in the community, including health insurance coverage, medical services, and overall health status.`,
  UI_MAP_METRIC_TITLE_COMM_INDEX: `Community Index`,
  UI_MAP_METRIC_TITLE_COM_INDEX: `Community Index`,
  UI_MAP_METRIC_DESC_COM_INDEX: `This index measures community assets and stability, including public amenities, safety, and residential/business security.`,
  UI_MAP_METRIC_TITLE_YTH_INDEX: `Youth & Family Index`,
  UI_MAP_METRIC_DESC_YTH_INDEX: `This index measures resources and support systems available to youth and families, including childcare access, afterschool programs, and family structure.`,
  ...
  UI_MAP_METRIC_TITLE_ECO_JOBALL: `All Jobs`,
  UI_MAP_METRIC_DESC_ECO_JOBALL: `Total number of jobs in the area.`,
  UI_MAP_METRIC_TITLE_ECO_LOWJOB: `Low Wage Jobs`,
  UI_MAP_METRIC_DESC_ECO_LOWJOB: `Proportion of jobs earning less than $1,500 a month.`,
  UI_MAP_METRIC_TITLE_ECO_MIDJOB: `Mid Wage Jobs`,
  UI_MAP_METRIC_DESC_ECO_MIDJOB: `Proportion of jobs earning between $1,500 and $3,333 a month.`,
  UI_MAP_METRIC_TITLE_ECO_OWNCB: `Owner-Occupied Cost-Burdened`,
  UI_MAP_METRIC_DESC_ECO_OWNCB: `Share of owner-occupied households that are cost-burdened.`,
  UI_MAP_METRIC_TITLE_ECO_RENTCB: `Renter-Occupied Cost-Burdened`,
  UI_MAP_METRIC_DESC_ECO_RENTCB: `Share of renter-occupied households that are cost-burdened.`,
  UI_MAP_METRIC_DESC_CRI_INDEX: `The Community Resource Index is an average of all Index categories (economics, education, family, health, and community). It presents an overall view of the resources available to each school's surrounding community.`,
  UI_MAP_METRIC_TITLE_COM_COMREC: `Community and Recreation Centers`, // TODO: Review translation
  UI_MAP_METRIC_TITLE_COM_VACBUS: `Business Vacancies`, // TODO: Review translation
  UI_MAP_METRIC_TITLE_COM_VACLTB: `Long-Term Business Vacancies`, // TODO: Review translation
  // HEL (Health) sub-metrics
  UI_MAP_METRIC_TITLE_HEL_CHKUPS: `Routine Doctor Visits`,
  UI_MAP_METRIC_DESC_HEL_CHKUPS: `Number of routine doctor visits annually, per 10,000 residents`,
  UI_MAP_METRIC_TITLE_HEL_INSCOV: `Health Insurance Coverage`,
  UI_MAP_METRIC_DESC_HEL_INSCOV: `Population with health insurance coverage`,
  UI_MAP_METRIC_TITLE_HEL_INSRAT: `Insurance Rate`,
  UI_MAP_METRIC_DESC_HEL_INSRAT: `Rate of health insurance coverage in the area`,
  UI_MAP_METRIC_TITLE_HEL_PHARMA: `Pharmacies`,
  UI_MAP_METRIC_DESC_HEL_PHARMA: `Licensed pharmacies, per 10,000 residents`,
  UI_MAP_METRIC_TITLE_HEL_SLEEP: `Sleep Health`,
  UI_MAP_METRIC_DESC_HEL_SLEEP: `Adults sleeping less than 7 hours per night, estimated per 10,000 population`,
  // COM (Community) sub-metrics
  UI_MAP_METRIC_TITLE_COM_EVICS: `Evictions`,
  UI_MAP_METRIC_DESC_COM_EVICS: `Number of evictions, per 10,000 residents`,
  UI_MAP_METRIC_TITLE_COM_LIBS: `Libraries`,
  UI_MAP_METRIC_DESC_COM_LIBS: `Libraries, per 10,000 residents`,
  UI_MAP_METRIC_TITLE_COM_URBHE: `Urban Health Environment`,
  UI_MAP_METRIC_DESC_COM_URBHE: `Urban health and environmental factors in the community`,
  UI_MAP_METRIC_TITLE_COM_VACLTR: `Long-Term Residential Vacancies`,
  UI_MAP_METRIC_DESC_COM_VACLTR: `Long-term residential vacancies (24+ months)`,
  UI_MAP_METRIC_TITLE_COM_VACRES: `Residential Vacancies`,
  UI_MAP_METRIC_DESC_COM_VACRES: `Overall residential vacancies in the area`,
  // YTH (Youth & Family) sub-metrics
  UI_MAP_METRIC_TITLE_YTH_BROAD: `Youth Broadband Access`,
  UI_MAP_METRIC_DESC_YTH_BROAD: `Children under 18 with broadband access`,
  UI_MAP_METRIC_TITLE_YTH_AFTSCL: `Afterschool Programs`,
  UI_MAP_METRIC_DESC_YTH_AFTSCL: `Afterschool program seats, per 10,000 children under age 18`,
  UI_MAP_METRIC_TITLE_YTH_CCCAFD: `Affordable Childcare Centers`,
  UI_MAP_METRIC_DESC_YTH_CCCAFD: `Licensed, affordable childcare centers, per 10,000 children under age 5`,
  UI_MAP_METRIC_TITLE_YTH_CCCALL: `All Childcare Centers`,
