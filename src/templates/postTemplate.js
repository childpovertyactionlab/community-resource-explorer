...
const PostTemplate = ({ data, ...props }) => {
  ...
  //     stat2num: 3,
  //     stat1text:
  //       "of residents with a bachelor's degree in one school community",
  //     stat2text:
  ...
  //     stat2num: "17,202",
  //     stat1text:
  //       "median household income in the most affluent campus community",
  //     stat2text:
  //       "median household income in the least affluent campus community",
  //   },
  // ]
  ...
  return (
    <Layout id="isd-page" activePageId={pages.ISD.id}>
      ...
      <Row id="page">
        ...
        {post.frontmatter.contents.map((el, i) => {
          if (el.type === "text") {
            return <MdxBlogSection key={"mdx_blog_section_" + i} {...el} />
          }
          if (el.type === "quote") {
            return <MdxQuote key={"mdx_quote_" + i} {...el} />
          }
          return null
        })}
      </Row>
