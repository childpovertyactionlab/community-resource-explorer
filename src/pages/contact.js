      ...
      <>
        ...
        >
          ...
          <Form.Group controlId="formGroupFirstName">
            <Form.Label className="required" name="first_name">
              First Name
            </Form.Label>
            <Form.Control
              required
          ...
          <Form.Group controlId="formGroupLastName">
            <Form.Label className="required" name="last_name">
              Last Name
            </Form.Label>
            <Form.Control
              required
          ...
          <Form.Group>
            <Form.Label htmlFor="newsletter-toggle">
  ...
  const getFaqSection = conditionalOption => {
    ...
    return (
      <>
        ...
        />
        <h3>
          Was your question answered? If not, please contact us using the form
          below.
        </h3>
        <br />
      </>
