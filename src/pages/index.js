...
const caroItems = [
  { 
    ...
    stat2text: "of residents with a bachelor's degree in another school community, 13 miles away",
  },
  { 
    src: running,
    alt: 's2',
    ...
    stat2text: "average life expectancy in another school community, 9 miles away",
  },
  { 
    src: swinging,
    alt: 's4',
